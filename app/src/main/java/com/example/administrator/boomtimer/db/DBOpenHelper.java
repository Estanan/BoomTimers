package com.example.administrator.boomtimer.db;
...
//            Constant.ICON_RESID + " integer)";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insertTag = "insert into " + Constant.TABLE_TAG + " (" +
                ...
                Constant.TAG_COLOR +
                ") values(?,?,?)";
        db.execSQL(insertTag, new String[]{"学习", "" + R.drawable.st_022, "" + Color.parseColor("#FF4081")});
        db.execSQL(insertTag, new String[]{"阅读", "" + R.drawable.cat_96, "" + Color.parseColor("#6495ed")});
        db.execSQL(insertTag, new String[]{"家务", "" + R.drawable.hpcd_079, "" + Color.parseColor("#191970")});
        db.execSQL(insertTag, new String[]{"运动", "" + R.drawable.sp_071, "" + Color.parseColor("#ff1493")});
        db.execSQL(insertTag, new String[]{"用餐", "" + R.drawable.fam_010, "" + Color.parseColor("#ffb6c1")});
        db.execSQL(insertTag, new String[]{"娱乐", "" + R.drawable.fam_021, "" + Color.parseColor("#da70d6")});
        db.execSQL(insertTag, new String[]{"购物", "" + R.drawable.fs_002, "" + Color.parseColor("#6495ed")});
        db.execSQL(insertTag, new String[]{"步行", "" + R.drawable.fam_043, "" + Color.parseColor("#ffb701")});
        db.execSQL(insertTag, new String[]{"上网", "" + R.drawable.cat_107, "" + Color.parseColor("#00B8D4")});
        db.execSQL(insertTag, new String[]{"交通", "" + R.drawable.tt_040, "" + Color.parseColor("#44700d39")});
